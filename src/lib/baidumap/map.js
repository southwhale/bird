// 该js脚本的AUTHENTIC_KEY只为iguzhi.cn服务
window.BMAP_AUTHENTIC_KEY = "7N4fvtbwng6xD29tTSwP4YOz";
(function() {
    function aa(a) {
        throw a;
    }
    ...
    w.C.Fw = function(a, b, c) {
        var a = w.C.N(a),
            d;
            // '<div id=zoomer style="position:absolute;z-index:0;top:0px;left:0px;overflow:hidden;visibility:hidden;cursor:url(http://api0.map.bdimg.com/images/openhand.cur),default"><div class="BMap_zoomer" style="top:0;left:0;"></div><div class="BMap_zoomer" style="top:0;right:0;"></div><div class="BMap_zoomer" style="bottom:0;left:0;"></div><div class="BMap_zoomer" style="bottom:0;right:0;"></div></div>"
    ...
    w.extend(Ka.prototype, {
        ...
        Hj: function(a, b, c, d) {
            ...
            if (c = c && d ? f.em(c, this.Ob) : this.uc)
                if (this.uc = new H(c.lng + a * e, c.lat - b * e), (a = f.Th(this.uc, this.Ob)) && g) this.vf = a
        },
        og: function(a, b) {
    ...
    var Rb = {
        ...
        style: "jshvp1",
        tile: "ueqmkp",
        vectordrawlib: "vy1rol",
        newvectordrawlib: "ux53eh",
        groundoverlay: "prwysx",
        pointcollection: "szobjv",
        marker: "4fs05d",
        symbol: "22un4i",
        canvablepath: "hw30ec",
        vmlcontext: "axiocl",
    ...
    w.object.extend(I, {
        ...
        JI: function(a) {
            if (a && this.JJ()[a])
                for (var a = this.JJ()[a], b = 0; b < a.length; b++) this.JI(a[b]), this.ud.Pk[a[b]] || this.IL(a[b])
        },
        IL: function(a) {
    ...
    function hb(a, b) {
        a && (this.wb = a, this.R = "spot" + hb.R++, b = b || {}, this.Ag = b.text || "", this.Gu = b.offsets ? b.offsets.slice(0) : [5, 5, 5, 5], this.TH = b.userData || p, this.uh = b.minZoom || p, this.jf = b.maxZoom || p)
    }
    hb.R = 0;
    ...
    fb.prototype.Hc = function() {
        this.map && this.map.H.Jk && (this.map.H.Jk.Da = q, w.lang.Rv(this.map.H.Jk.R), this.map.H.Jk = p)
    };
    ...
    w.extend(Bc.prototype, {
        ...
        SC: function(a, b) {
            return this.map.ja() === Oa ? "TILE-" + b.R + "-" + this.map.Ev + "-" + a[0] + "-" + a[1] + "-" + a[2] : "TILE-" + b.R + "-" + a[0] + "-" + a[1] + "-" + a[2]
        },
        Bw: function(a) {
            var b = a.rb;
            ...
            for (var b = this.fm.concat(this.Gf), c = b.length, d = 0; d < c; d++) {
                ...
                if (e.zv) {
                    ...
                    if (this.map.Mb()) {
                        ...
                        continue
                    } else f.style.display = "block", this.ve.style.display = "none", this.map.dispatchEvent(new L("vectorchanged"), {
                        isvector: q
                    })
                }
        ...
        $g: function(a) {
            ...
            if (a instanceof cb) b && a.am && (a.remove(), a.am = q);
                ...
                if (a.xo)
                    for (var b = 0, c = this.ng.length; b < c; b++) a == this.ng[b] && this.ng.splice(b, 1);
                else {
                    b = 0;
        ...
        Os: function(a) {
            ...
            if (!this.map.Mb() && (a ? this.map.D.$X = a : a = this.map.D.$X, a))
                for (var c = p, c = "2" == z.Kx ? [z.url.proto + z.url.domain.main_domain_cdn.other[0] + "/"] : [z.url.proto + z.url.domain.main_domain_cdn.baidu[0] + "/", z.url.proto + z.url.domain.main_domain_cdn.baidu[1] + "/", z.url.proto + z.url.domain.main_domain_cdn.baidu[2] + "/"], d = 0, e; e = this.fm[d]; d++)
                    if (e.PX == o) {
                        b.k.Wc = 18;
    ...
    ob.prototype.getTilesUrl = function(a, b) {
        var c = a.x,
            d = a.y,
            e = this.kc,
            c = Nc[Math.abs(c + d) % Nc.length] + "/image?grids=" + c + "_" + d + "_" + b + "&q=" + e.hx + "&tags=" + e.gt + "&filter=" + e.filter + "&sortby=" + e.Cx + "&ak=" + this.kc.pl + "&age=" + e.wv + "&page_size=" + e.NW + "&format=" + e.iY;
    ...
    w.extend(Na.prototype, {
        ...
        tA: function() {
            if (this.B)
                for (var a = this.B.MC(), b = 0; b < a.length; b++)(a[b] instanceof R || a[b] instanceof pc) && a[b].point && this.ka.push(a[b])
        },
        eE: ba("B"),
        Qs: function(a) {
            this.rf = a || "none"
    ...
    we.prototype = {
        ...
        fu: function(a) {
            if (!(je && 0 !== a.touches.length)) {
                ...
                if (b.uk) d = b.scale * b.yo, d = Math.max(b.options.tk, d), d = Math.min(b.options.hp, d), b.yo = d / b.scale, b.scale = d, b.x = b.Yw - b.Yw * b.yo + b.x, b.y = b.Zw - b.Zw * b.yo + b.y, b.zb.style[be] = "200ms", b.zb.style[$d] = "translate(" + b.x + "px," + b.y + "px) scale(" + b.scale + ")" + ve, b.uk = q, b.refresh(), b.options.Do && b.options.Do.call(b, a);
                else {
                    if (b.Vg) {
                        ...
                        if (je)
                            if (b.cJ && b.options.zoom) clearTimeout(b.cJ), b.cJ = p, b.options.Eo && b.options.Eo.call(b, a), b.zoom(b.ig, b.jg, 1 == b.scale ? b.options.XT : 1), b.options.Do && setTimeout(function() {
                                b.options.Do.call(b, a)
                            }, 200);
                            else if (this.options.YC) {
