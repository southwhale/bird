/**
 * 解决ie8、ie9等浏览器对input事件支持存在bug的问题
 * 这里重新定义了一个textchange事件
 */
define(function (require) {

    var exports = {};

    exports.fixBugForInputEvent = function (event) {
        ...
        if (isInputSupported) {
            event.on(document, "input", function(e) {
            ...
            event.on(document, "focusout", function() {
                stopWatching();
            });
